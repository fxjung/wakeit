...
const string homepage_string = "http://www.wilhelm-gym.net/~felix.jung/wakeit";
...
void usage() {
  ...
  cout << "Melden Sie Programmfehler bitte an <" << email_string << ">" << endl;
  cout << "Homepage: <" << homepage_string << ">" << endl;
}
